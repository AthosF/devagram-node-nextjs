...
export const conectarMongoDB = (handler : NextApiHandler) =>
    ...
    //verificar se o banco ja estea conectado, se estiver seguir para endpoint ou proximo middleware
    if(mongoose.connections[0].readyState){
        return handler(req, res);
    }

    //ja que nao esta conectado vamos conectar obter variavel de ambiente preenchida do env
